...
my %active_alerts = (
  ...
  '4h'  => [
    ...
    cross_sh('4h', 'sma', 34, 68),
    cross_sh('4h', 'sma', 68, 34),
  ...
  '12h' => [
    ...
    bullish_divergence_sh('12h'),
    bearish_divergence_sh('12h'),
    cross_sh('12h', 'sma', 34, 68),
    cross_sh('12h', 'sma', 68, 34),
  ...
  '1d'  => [
    ...
    cross_sh('1d', 'ema', 9, 13),
    cross_sh('1d', 'ema', 13, 9),
    bullish_divergence_sh('1d'),
    bearish_divergence_sh('1d'),
    cross_sh('1d', 'sma', 34, 68),
    cross_sh('1d', 'sma', 68, 34),
